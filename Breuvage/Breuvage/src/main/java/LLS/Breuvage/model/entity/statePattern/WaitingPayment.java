...
public class WaitingPayment implements IPurchaseOrderState {
    @Override
    ...
    public void cancelOrderNotCollected(PurchaseOrder order) {
        throw new InvalidOrderStateChangeException("the payment wasn't completed, request denied");
    }
    ...
    public void orderOutOfStock(PurchaseOrder order) {
        throw new InvalidOrderStateChangeException("stock confirmed, request denied");
    }
    ...
    public void orderPending(PurchaseOrder order) {
        throw new InvalidOrderStateChangeException("waiting payment, request denied");
    }
    ...
    public void orderWaitingPayment(PurchaseOrder order) {
        throw new InvalidOrderStateChangeException("the payment is already waiting, request denied");
    }
}
