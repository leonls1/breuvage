...
public class RejectedPayment implements IPurchaseOrderState {
    @Override
    public void cancelOrderByUSer(PurchaseOrder order) {
        throw new InvalidOrderStateChangeException("the payment was  rejected, request denied");
    }
    ...
    public void orderRejectedPayment(PurchaseOrder order) {
        throw new InvalidOrderStateChangeException("the payment was already rejected, request denied");
    }

    @Override
    public void orderWaitingPayment(PurchaseOrder order) {
        /// /// offer a payment alternative
    }
}
